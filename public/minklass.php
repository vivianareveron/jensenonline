              ...
              <div class="widget">
                ...
                <div class="widget-content">
                    ...
                    <div class="shortcuts">
                        ...
                        <div>    
                        <a href="searchclass.php" class="shortcut"><i class="shortcut-icon icon-list-alt"></i><span class="shortcut-label">Change user</span> </a>
                        </div>
                        <div>
                        <a href="searchclass.php" class="shortcut"><i class="shortcut-icon icon-list-alt"></i> <span class="shortcut-label">Delete user</span> </a>
                        </div>
